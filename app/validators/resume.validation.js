...
class ResumeValidation {
    ...
    hired() {
        return [
            ...
            body('from_date')
                .notEmpty()
                .withMessage('resume.validations.from_date_required')
                .isISO8601()
                .toDate()
                .withMessage('resume.validations.from_date_must_be_date')
                .trim(),
            body('to_date')
                .notEmpty()
                .withMessage('resume.validations.to_date_required')
                .isISO8601()
                .toDate()
                .withMessage('resume.validations.to_date_must_be_date')
                .trim(),
            body('income')
                .notEmpty()
