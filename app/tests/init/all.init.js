...
import { users, companies, projects, positions, managers, resumes, resumeComments, loginHistory, interviews, tags, fcmTokens, skills } from '../data/data';
...
class AllInit {
    async setData() {
        ...
        await loginHistory.insertMany(loginHistory);
